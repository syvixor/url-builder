...
const generatedUrl = computed(() => {
    return selectedIcons.value.length > 0 ? `${baseUrl}?i=${selectedIcons.value.join(",")}` : baseUrl
});
                ...
                <div class="ring-1 ring-neutral-200 dark:ring-neutral-800 backdrop-blur-xs rounded-lg space-y-6 p-4">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div v-if="isPreviewable" class="space-y-2">
                            ...
                            <img v-if="selectedCount > 0" :src="generatedUrl" alt="Preview" loading="lazy">
            ...
            <motion.div :initial="{ opacity: 0 }" :animate="{ opacity: 1 }" :transition="{ delay: 0.6, duration: 0.5 }"
                ...
                <div class="ring-1 ring-neutral-200 dark:ring-neutral-800 backdrop-blur-xs rounded-lg space-y-6 p-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div v-else class="grid grid-cols-5 md:grid-cols-10 lg:grid-cols-20 gap-2">
